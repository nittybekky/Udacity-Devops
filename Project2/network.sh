...
then
    ...
    aws cloudformation create-stack --stack-name $stack_name --template-body file://ournetwork.yml  --parameters file://ourparameters.json --capabilities "CAPABILITY_IAM" "CAPABILITY_NAMED_IAM" --region=us-east-1
    ...
    then
        ...
        aws cloudformation update-stack --stack-name $stack_name --template-body file://ournetwork.yml  --parameters file://ourparameters.json --capabilities "CAPABILITY_IAM" "CAPABILITY_NAMED_IAM" --region=us-east-1
